...
<div class="flex flex-col items-center justify-center h-full">
  <img src="/public/expanso-logo-light.svg" class="logo mb-16" alt="Expanso" />
...
<div class="mt-16">
  <div class="headline text-cyan mb-8">
...
<div class="grid grid-cols-3 gap-12 items-center mt-16">
  ...
  <div class="text-center">
    <div class="text-cyan font-bold mb-2" style="font-size: 42pt;">100% VOLUME</div>
    <div class="text-6xl text-dim">→→→</div>
    <div class="text-red mt-2" style="font-size: 36pt;">Full Firehose</div>
  </div>
...
<div class="text-center mt-16">
  ...
  <p class="body-text text-red font-bold">(Runaway Costs)</p>
</div>
...
<div class="grid grid-cols-2 gap-16 mt-16">
  ...
  <div class="box-cyan text-center">
    <h3 class="text-white mb-8">AFTER</h3>
    <div class="flex flex-col items-center gap-6">
      <div class="text-7xl">📊</div>
      <div class="text-cyan" style="font-size: 42pt;">↓</div>
      <div class="px-8 py-6 bg-cyan text-white font-bold rounded-xl" style="font-size: 36pt; background: #00D9FF;">EXPANSO</div>
      <div class="text-cyan" style="font-size: 42pt;">↓</div>
      <div class="body-text text-cyan font-bold">30% Data</div>
      <div class="text-cyan" style="font-size: 42pt;">↓</div>
      <div class="text-7xl">☁️</div>
    </div>
    <div class="text-7xl mt-8">💰</div>
...
<div class="grid grid-cols-3 gap-8">
  <div class="box-cyan text-center p-8">
...
<div class="flex items-center justify-between gap-8 my-16">
  ...
  <div class="text-center">
    <div class="platform-logos flex-col gap-4">
      <img src="/sli-dev/public/logos/snowflake.svg" class="platform-logo" alt="Snowflake" />
      <img src="/sli-dev/public/logos/databricks.svg" class="platform-logo" alt="Databricks" />
      <img src="/sli-dev/public/logos/splunk.svg" class="platform-logo" alt="Splunk" />
      <img src="/sli-dev/public/logos/datadog.svg" class="platform-logo" alt="Datadog" />
    </div>
  </div>
</div>

<p class="text-center body-text text-cyan font-semibold mt-12">
...
<div class="text-center">
  <div class="inline-block px-16 py-8 rounded-2xl font-bold text-white" 
       style="background: #00D9FF; font-size: 56pt;">
...
<div class="flex justify-center gap-12 mt-16">
  <div class="box text-center p-8">
    ...
    <div class="body-text text-cyan font-bold">Free Assessment</div>
  </div>
  <div class="box text-center p-8">
    <div class="text-5xl mb-3">💰</div>
    <div class="body-text text-cyan font-bold">ROI Calculator</div>
  </div>
  <div class="box text-center p-8">
    <div class="text-5xl mb-3">🚀</div>
    <div class="body-text text-cyan font-bold">Quick Deploy</div>
  </div>
</div>
